            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4" id="home">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:border-gray-700">
                        <li>
                            <ScrollLink to="home" smooth={true} className="block py-2 pl-3 pr-4 text-white bg-slate-800 rounded md:bg-transparent hover:cursor-pointer md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</ScrollLink>
                        </li>
                        <li>
                            <ScrollLink to="about" smooth={true} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 hover:cursor-pointer md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</ScrollLink>
                        </li>
                        <li>
                            <ScrollLink to="work" smooth={true} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 hover:cursor-pointer md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Work</ScrollLink>
                        </li>
                        <li>
                            <ScrollLink to="contact" smooth={true} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 hover:cursor-pointer md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</ScrollLink>
                        </li>
                    </ul>        
                </div>
            </div>
